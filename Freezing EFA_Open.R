...
#####################################################################################################
## This csv was saved after initial data cleaning to extract PHI. If you are interested in details ##
## not covered in this csv or have questions about this data, please contact mmarder2@illinois.edu ##
#####################################################################################################

## Load Data, use 'freezing_raw_open.csv'
freezing_raw_d_age<-read.csv(file.choose())
...
ggplot(freezing_demo, aes(x=con_date.x, y=atq_avoi, color=GENDER)) +
  geom_point(shape=1) +
  scale_colour_hue(l=50) +
  geom_smooth(method=lm, se=F) +
  labs(x= "date of completion", y= "avoidance") +
  labs(color= "Gender")

t.test(atq_appr ~ GENDER, data = freezing_demo_twogender, alternative = "greater", var.equal = FALSE)

ggplot(freezing_demo, aes(x=con_date.x, y=atq_appr, color=GENDER)) +
  geom_point(shape=1) +
  scale_colour_hue(l=50) +
  geom_smooth(method=lm, se=F) +
  labs(x= "date of completion", y= "approach") +
  labs(color= "Gender")
